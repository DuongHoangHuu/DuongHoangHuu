...
public class DHH_Blockchain {
    public static ArrayList<VNPT_Huu> blockchain = new ArrayList<VNPT_Huu>();
    public static int difficulty = 5;
    public static float minimumTransaction = 0.1f;
    public static DHH_Store DHH_Kho; //Kho
    public static DHH_Store DHH_Cuahang; //Cửa hàng
    ...
    public static void main(String[] args) {
        ...
        //Tạo ra các store
        DHH_Kho = new DHH_Store();
        DHH_Cuahang = new DHH_Store();
        DHH_Store coinbase = new DHH_Store();
        Transaction sendFund;
        System.out.print("-Nhập số lượng VNPT-Net Router đang tồn trong kho : ");
        float initBalanceA = sc.nextFloat();
        //Khởi tạo giao dịch gốc, để nhập số lượng VNPT-Net Router có trong kho DHH_Kho
        genesisTransaction = new Transaction(coinbase.publicKey, DHH_Kho.publicKey, initBalanceA, null);
        ...
        VNPT_Huu genesis = new VNPT_Huu("0");
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);
        System.out.println("-Số lượng VNPT-Net Router trong kho là : " + DHH_Kho.getBalance());
        System.out.print("-Nhập số lượng VNPT-Net Router đang còn tại Cửa hàng : ");
        float initBalanceB = sc.nextFloat();
        //Khởi tạo giao dịch gốc, để nhập số lượng VNPT-Net Router còn tại cửa hàng kho DHH_Cuahang
        genesisTransaction = new Transaction(coinbase.publicKey, DHH_Cuahang.publicKey, initBalanceB, null);
        genesisTransaction.generateSignature(coinbase.privateKey); //Gán private key (ký thủ công) vào giao dịch gốc
        ...
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);
        System.out.println("-Số lượng VNPT-Net Router đang có tại Cửa hàng là : " + DHH_Cuahang.getBalance());
        VNPT_Huu block1 = new VNPT_Huu(genesis.hash);
        boolean fail = true;
        while (fail){
            ...
            sendFund = DHH_Kho.sendFunds(DHH_Cuahang.publicKey, numberTransfer);
            if (sendFund==null){
                continue;
            }else{
                fail= false;
        ...
        System.out.println("-Số lượng VNPT-Net Router trong kho hiện tại là : " + DHH_Kho.getBalance());
        System.out.println("-Số lượng VNPT-Net Router của Cửa hàng hiện tại là : " + DHH_Cuahang.getBalance());
    }
    public static Boolean isChainValid() {
        VNPT_Huu currentBlock;
        VNPT_Huu previousBlock;
    ...
    public static void addBlock(VNPT_Huu newBlock) {
        newBlock.mineVNPT_Huu(difficulty);
