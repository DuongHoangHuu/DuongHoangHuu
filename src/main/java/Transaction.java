...
public class Transaction {
    ...
    public boolean processTransaction() {
        ...
        for(TransactionInput i : inputs) {
            i.UTXO =DHH_Blockchain.UTXOs.get(i.transactionOutputId);
        }
        //Kiểm tra giao dịch hợp lệ
        if(getInputsValue() < DHH_Blockchain.minimumTransaction) {
            System.out.println("Số lượng VNPT-Net Router bạn chon quá bé : " + getInputsValue());
            System.out.println("Vui lòng nhập lại số lượng lớn hơn : " + DHH_Blockchain.minimumTransaction);
            return false;
        }
        ...
        for(TransactionOutput o : outputs) {
            DHH_Blockchain.UTXOs.put(o.id , o);
        }
        ...
        for(TransactionInput i : inputs) {
            ...
            DHH_Blockchain.UTXOs.remove(i.UTXO.id);
        }
        return true;
    }
